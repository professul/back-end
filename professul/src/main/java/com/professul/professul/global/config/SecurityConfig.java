...
import com.professul.professul.global.auth.jwt.CustomLogoutFilter;
import com.professul.professul.global.auth.jwt.JWTFilter;
import com.professul.professul.global.auth.jwt.JWTUtil;
import com.professul.professul.global.auth.jwt.LoginFilter;
...
public class SecurityConfig {
    ...
    public SecurityFilterChain filterChain(HttpSecurity http) throws Exception {
        ...
        http.authorizeHttpRequests((auth) -> auth //경로별 인가 작업
                ...
                .requestMatchers("/", "/login", "/join", "/reissue", "/review/*").permitAll()
